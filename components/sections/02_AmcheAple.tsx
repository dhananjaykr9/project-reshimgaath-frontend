...
import { GraduationCap, Briefcase, Quote, Heart, Sparkles, Camera, ArrowRightCircle, Clock, PartyPopper } from "lucide-react";
        ...
        <div className="grid grid-cols-2 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <motion.div
              ...
              className="aspect-[4/5] bg-white p-2 pb-10 rounded-xl shadow-xl border border-mauli-gold/5 relative group"
            >
