      ...
      <div className="z-50 text-center w-full max-w-6xl px-4 flex flex-col items-center justify-center flex-grow py-8">
        ...
        >
            <div className="relative py-4">
              <h1 className="font-marathi text-[12vw] md:text-[9rem] text-[#800000] font-black leading-[1] md:leading-[1.1] tracking-tighter drop-shadow-md">
                  <span className="block lg:inline-block px-4">{COUPLE.groom.name}</span>
                  <span className="block lg:inline-block text-3xl md:text-7xl text-[#D4AF37] font-serif italic mx-0 lg:mx-10 opacity-90 my-2 lg:my-0">
                  &
                  </span>
